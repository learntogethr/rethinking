...
## Conjecture: The number of possibilities consistent with what we know about the contents of the observable events
...
grid_approx <- function(points, prior, verbose = FALSE) {
  ...
  p + 
    scale_color_discrete(name = "Distribution", h = c(200, 300)) +
    labs(
      title = glue::glue("Grid Approximation at {points} Points with prior set at {prior}"),
...
```{r}
grid_approx(points = 20, prior = .5)
```

```{r}
grid_approx(20, 1, verbose = T) 
```
